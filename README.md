...
| Textarea           | Complete | Native textarea semantics, accessible labeling, keyboard accessibility, required and disabled states, helper and error messaging, controlled and uncontrolled usage, visible focus styling, screen reader support                                                                                   |
