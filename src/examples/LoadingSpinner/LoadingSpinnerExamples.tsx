        ...
        tabs={[
          {
            ...
            content: (
              <>
                ...
                <p>
                  The Loading Spinner supports spinner, dots, pulse, bars,
                  orbit, and comet presentations for communicating indeterminate
                  activity.
                </p>
                ...
                <p>
                  Animation variants can be combined with the <code>size</code>{' '}
                  prop to create loading indicators of different visual sizes.
                </p>
          ...
          },
          {
            ...
            content: (
              <>
                ...
                <p>
                  Size, colour, animation variant, and accessible labels can be
                  combined to create loading indicators appropriate for
          ...
          },
          {
            ...
            content: (
              <>
                ...
                <p>
                  Use the <code>showLabel</code> prop to display the loading
                  message alongside the indicator.
                </p>
