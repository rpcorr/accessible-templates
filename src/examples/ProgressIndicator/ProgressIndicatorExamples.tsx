...
export const ProgressIndicatorExamples = () => {
  ...
  return (
    <section>
      ...
      <div className="stack">
        <ProgressIndicator value={25} label="Downloading files" showValue />

        <ProgressIndicator value={50} label="Installing updates" showValue />

        <ProgressIndicator value={75} label="Processing request" showValue />
      ...
      <div className="stack">
        <ProgressIndicator value={progress} label="Uploading files" showValue />

        <div>
          <button type="button" onClick={startProgress} disabled={isRunning}>
            Start upload
          </button>
